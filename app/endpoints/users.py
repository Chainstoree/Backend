...
class SigninUser(Resource):
    ...
    def post(self):
        try:
            ...
            if get_user:
                return {"status": False, "responseMessage": "email is already registered", "responseData":"", "responseCode":"01","statusCode": 409}, 409
            ...
            #creating jwt
            access_token = create_access_token(identity=user.get("email"), fresh=True)
            refresh_token = create_refresh_token(identity=user.get("email"))

            return {"status": True, "responseMessage": "Registration successful!",  "accessToken":access_token, "refreshToken":refresh_token, "responseData":"", "responseCode":"00", "statusCode": 200}, 200
